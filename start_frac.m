...
Initial_Energy = 0.5;
Min_Energy = 0.01;
frac_FileName = 'C:/Users/RaviHome/Desktop/Results_H/fraction_energy/ALCP/analysis_HEED.txt';
...
for i=1 : Num_Sensors        
    ...
    [frac_sum_avg, aveCHE_ratio] = run_ALCP_H (Packet_Size, Packet_Transmission_Cost, Amplification_Energy_Multi_Path, Amplification_Energy_Free_Space, Energy_Data_Aggregation, Num_Sensors, BS, Threshold_Distance, Sensor_Nodes, Distance, Sensor_Node_Energy, current_Cluster_Radius, count, Min_Energy, numFrames);
