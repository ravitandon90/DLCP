...
while (count < maxCount)
    ...
    current_Cluster_Radius = 4*Area_Net/sqrt(Num_Sensors);
    filePath = '..\Sensor_Network\Sensor_Network_';
    fileExtension = '_200.txt';
    fileName = strcat (filePath, int2str(Area_Net), fileExtension);
...
Area_Net = Area_Net + Area_Net_Step;
end
